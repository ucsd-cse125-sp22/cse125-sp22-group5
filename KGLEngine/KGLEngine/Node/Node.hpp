...
public:
    ...
    vec3 initialRotationVariation;
    vec3 rotatingSpeed;
    vec3 rotatingSpeedVariation;
    bool randomizeRotatingDirection;
    vec3 initialScale;
    vec3 initialScaleVariation;
    vec3 scalingSpeed;
    vec3 scalingSpeedVariation;
    Texture* texture;
    vec4 color;
    Particle3DNode(string modelFile, unsigned int birthrate, float duration, float durationVariation);
