...
//    newMap->scale = vec3(5);
    ...
    plant1Shader->setDiffuseMap(new Texture("/Resources/Game/Map/T_Plant_01_Albedo.png"));
    plant1Shader->setNormalMap(new Texture("/Resources/Game/Map/T_Plant_01_Normal.png"));
    ...
    rocksmShader->setDiffuseMap(new Texture("/Resources/Game/Map/T_Rock_Surface_01_Albedo.png"));
    rocksmShader->setNormalMap(new Texture("/Resources/Game/Map/T_Rock_Surface_01_Normal.png"));
    ...
    rockPileShader->setDiffuseMap(new Texture("/Resources/Game/Map/T_Rock_Pile_01_Albedo.png"));
    rockPileShader->setNormalMap(new Texture("/Resources/Game/Map/T_Rock_Pile_01_Normal.png"));
    ...
    fernShader->setDiffuseMap(new Texture("/Resources/Game/Map/T_Fern_01_Albedo.png"));
    fernShader->setNormalMap(new Texture("/Resources/Game/Map/T_Fern_01_Normal.png"));
    Node* fern5 = new Node();
    ...
    ivyAtlasShader->setDiffuseMap(new Texture("/Resources/Game/Map/T_Ivy_Atlas_01_Albedo.png"));
    ivyAtlasShader->setNormalMap(new Texture("/Resources/Game/Map/T_Ivy_Atlas_01_Normal.png"));
    PBRShader* ivyTileableShader = new PBRShader(0.3, 0.5);
    ivyTileableShader->setDiffuseMap(new Texture("/Resources/Game/Map/T_Ivy_Tileable_01_Albedo.png"));
    ivyTileableShader->setNormalMap(new Texture("/Resources/Game/Map/T_Ivy_Tileable_01_Normal.png"));
    Node* ivy1 = new Node();
    ...
    grassShader->setDiffuseMap(new Texture("/Resources/Game/Map/T_Grass_03_Albedo.png"));
    grassShader->setNormalMap(new Texture("/Resources/Game/Map/T_Grass_03_Normal.png"));
    ...
    plankShader->setDiffuseMap(new Texture("/Resources/Game/Map/T_Wood_01_Albedo.png"));
    plankShader->setNormalMap(new Texture("/Resources/Game/Map/T_Wood_01_Normal.png"));
    ...
    torchShader->setDiffuseMap(new Texture("/Resources/Game/Map/T_Torch_01_Albedo.png"));
    torchShader->setNormalMap(new Texture("/Resources/Game/Map/T_Torch_01_Normal.png"));
    ...
    rootShader->setDiffuseMap(new Texture("/Resources/Game/Map/T_Roots_01_Albedo.png"));
    rootShader->setNormalMap(new Texture("/Resources/Game/Map/T_Roots_01_Normal.png"));
    Node* root1 = new Node();
    ...
    chest1->loadModelFile("/Resources/Game/Map/chest.dae");
    chest1->geometries[0]->setShader(wallShader8);
    chest1->geometries[0]->setDoubleSided();
    chest1->geometries[1]->setShader(plankShader);
    chest1->geometries[1]->setDoubleSided();
    chest1->geometries[2]->setShader(wallShader8);
    chest1->geometries[2]->setDoubleSided();
    chest1->geometries[3]->setShader(plankShader);
    chest1->geometries[3]->setDoubleSided();
    ...
    ruinedShader->setDiffuseMap(new Texture("/Resources/Game/Map/T_Ballustrade_01_Albedo.png"));
    ruinedShader->setNormalMap(new Texture("/Resources/Game/Map/T_Ballustrade_01_Normal.png"));
    ...
    barkShader->setDiffuseMap(new Texture("/Resources/Game/Map/T_Ash_Tree_Bark_01_Albedo.png"));
    barkShader->setNormalMap(new Texture("/Resources/Game/Map/T_Ash_Tree_Bark_01_Normal.png"));
    PBRShader* treeShader = new PBRShader(0.2, 0.7);
    treeShader->setDiffuseMap(new Texture("/Resources/Game/Map/T_Ash_Tree_Canopy_01_Albedo.png"));
    treeShader->setNormalMap(new Texture("/Resources/Game/Map/T_Ash_Tree_Canopy_01_Normal.png"));
    Node* tree1 = new Node();
