...
namespace UISizes{
	...
	const glm::vec2 avatarIconSize = glm::vec2(0.256, 0.256);
	...
	const glm::vec2 partyMpBarSize = glm::vec2(0.535, 0.053);
	...
	// Magic ==============
	const glm::vec2 magicBackSize = glm::vec2(0.635,0.431);
	const glm::vec2 magicButtonBackSize = glm::vec2(0.206, 0.206);
	const glm::vec2 magicIconSize = glm::vec2(0.200,0.200);
	const glm::vec2 magicIconSmallScale = glm::vec2(0.65);
	...
	// setting ===============
	//const glm::vec2 settingBackSize = glm::vec2();
	//const glm::vec2 settingButtonSize = glm::vec2();
