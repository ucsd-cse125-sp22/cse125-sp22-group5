...
void main() {
    ...
    worldPosition *= 10.0f;
    vec3 swayFactor;
    swayFactor.x = sin(worldPosition.x + timeFactor) * 0.005f;
    swayFactor.y = sin(worldPosition.y + timeFactor) * 0.005f;
    swayFactor.y += cos(worldPosition.x + timeFactor) * 0.005f;
    swayFactor.y += cos(worldPosition.z + timeFactor) * 0.005f;
    swayFactor.z = cos(worldPosition.z + timeFactor) * 0.005f;
    localPosition.xyz += swayFactor * 2.0f;
