...
void main() {
    ...
    swayFactor.y = sin(worldPosition.y + timeFactor) * 0.01f;
    swayFactor.y += cos(worldPosition.x + timeFactor) * 0.01f;
    swayFactor.y += cos(worldPosition.z + timeFactor) * 0.01f;
    swayFactor.z = cos(worldPosition.z + timeFactor) * 0.005f;
    localPosition.xyz += swayFactor * 3.0f;
